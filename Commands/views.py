...
def execute_md_simulation(request, md_mutation_folder, project_name, command_tool, project_id, user_id):
    ...
    for i in range(int(md_run_no_of_conformation)):
        ...
        popen_change_dir = source_file_path + '/md_run' + str(i + 1)
        print("start editconf==========================================")
        print(os.getcwd())
        print("gmx editconf -f complex_out.gro -o  newbox.gro -bt cubic -d 1.2")
        md_editconf = "gmx editconf -f complex_out.gro -o  newbox.gro -bt cubic -d 1.2"
        process_return = execute_command_md_run(md_editconf,popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu editconf\n"+out+"\n-----------error------\n"+err)

        print("gmx solvate -cp newbox.gro -cs spc216.gro -p topol.top -o solve.gro")
        print("start solvate==========================================")
        print(os.getcwd())
        md_solvate = "gmx solvate -cp newbox.gro -cs spc216.gro -p topol.top -o solve.gro"
        process_return = execute_command_md_run(md_solvate, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu solvate\n" + out + "\n-----------error------\n" + err)

        print("start make_ndx==========================================")
        print(os.getcwd())
        print("echo q | gmx make_ndx -f solve.gro > gromacs_solve_gro_indexing.txt")
        md_make_ndx = "echo q | gmx make_ndx -f solve.gro > gromacs_solve_gro_indexing.txt"
        process_return = execute_command_md_run(md_make_ndx, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu make_ndx\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_grompp1, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_grompp1\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_genion, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu genion\n" + out + "\n-----------error------\n" + err)
        ...
        process_return =  execute_command_md_run(md_make_ndx2, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_make_ndx2\n" + out + "\n-----------error------\n" + err)
        ...
        process_return =  execute_command_md_run(md_grompp2, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_grompp2\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_mdrun1, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_mdrun1\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_grompp3, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_grompp3\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_mdrun2, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_mdrun2\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_grompp4, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_grompp4\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_mdrun3, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_mdrun3\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_grompp5, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
        file_outpu_md.write("outpu md_grompp5\n" + out + "\n-----------error------\n" + err)
        ...
        process_return = execute_command_md_run(md_mdrun4, popen_change_dir,source_file_path2)
        out, err = process_return.communicate()
        process_return.wait()
